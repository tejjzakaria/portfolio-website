...
import { FaArrowCircleLeft, FaArrowDown, FaSave, FaTrash } from "react-icons/fa";
        ...
        const fetchProject = async () => {
            ...
            try {
                ...
                setForm({
                    ...
                    team: Array.isArray(data.team) ? data.team.join(", ") : "",
      ...
      <Navbar>
        ...
        >
          <div className="shadow-input mx-auto w-full max-w-md rounded-none bg-white p-4 md:rounded-2xl md:p-8 dark:bg-black border border-white-500 relative z-10" style={{
            ...
            <h2 className="text-xl font-bold text-neutral-800 dark:text-neutral-200 mb-2">Edit Project</h2>
            <p className="mt-2 max-w-sm text-sm text-neutral-600 dark:text-neutral-300 mb-6">Update the project details below.</p>
