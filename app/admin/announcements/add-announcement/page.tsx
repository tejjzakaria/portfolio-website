...
const AddAnnouncementPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setForm({ title: "", message: "", author: "", status: "active" });
    } catch (err: any) {
      setError(err.message || "Error adding announcement");
    } finally {
      setLoading(false);
    }
  };
    ...
    <Navbar>
      ...
      >
        <div className="shadow-input mx-auto w-full max-w-md rounded-none bg-white p-4 md:rounded-2xl md:p-8 dark:bg-black border border-white-500 relative z-10" style={{
          ...
          <h2 className="text-xl font-bold text-neutral-800 dark:text-neutral-200 mb-2">Add Announcement</h2>
          <p className="mt-2 max-w-sm text-sm text-neutral-600 dark:text-neutral-300 mb-6">Fill out the form to add a new announcement.</p>
