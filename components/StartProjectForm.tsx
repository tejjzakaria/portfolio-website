...
import { FaLocationArrow, FaArrowCircleLeft } from "react-icons/fa";
        ...
        <div className='pb-20 pt-36'>
            ...
            <div className="shadow-input mx-auto w-full max-w-md rounded-none bg-white p-4 md:rounded-2xl md:p-8 dark:bg-black border border-white-500" style={{
                ...
                <p className="mt-2 max-w-sm text-sm text-neutral-600 dark:text-neutral-300">
                    Let’s build your vision—share your details and I’ll reach out soon.
                </p>
                ...
                <form className="my-8" onSubmit={handleSubmit}>
                    ...
                    <LabelInputContainer className="mb-4">
                        ...
                        <Input id="email" placeholder="johndoe@tejjzakaria.com" type="email" />
                    </LabelInputContainer>
                    ...
                    <div className="flex flex-row justify-center items-center gap-4">
                        ...
                        <div className="flex justify-center items-center group/btn relative h-10 w-full rounded-md border border-white/20 bg-transparent backdrop-blur-none font-medium text-white transition-all duration-300 hover:bg-white/15 hover:backdrop-blur-md hover:border-white/40 hover:shadow-lg hover:shadow-white/10 active:scale-95 dark:border-white/15 dark:text-white dark:hover:bg-white/10 dark:hover:backdrop-blur-md dark:hover:border-white/25">
                            <Link href='/'>
                                <FaArrowCircleLeft />
                                <BottomGradient />
                            </Link>
