    ...
    return (
        <div className='flex flex-col justify-center items-center' id='services'>
            <div className='w-[60vw]'>
                ...
                <p className='text-center mt-6 font-light'>I build websites and web applications that are fast, functional, and user-friendly. From front-end design to back-end development, I turn ideas into digital solutions that solve real problems.</p>
            </div>
